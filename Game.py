	...
	def draw(self) :
		...
		for i in range(3) :
			for j in range(3) :
				...
				cv2.rectangle(self.image,start_point,end_point,(0,0,255),-1)
				...
				cv2.putText(self.image,value,(j*(self.width//3)+25,(i*self.height//3)+100),cv2.FONT_HERSHEY_SIMPLEX,5,(178,34,34),5)
		if self.checkWin() :
